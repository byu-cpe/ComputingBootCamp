This is the log used to record how the VM was created.    You don't have to do any of the instructions up top.  They are there to be a public record of how to create a new machine.
